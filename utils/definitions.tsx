...
export const ATTACHMENT_MEDIA_PROXY_BASE = new URL("https://media.discordapp.net/attachments");
export const ASSET_MEDIA_PROXY_BASE = new URL("https://media.discordapp.net");
export const PRIMARY_DOMAIN_BASE = new URL("https://discord.com");
export const IMAGE_EXT_1_DOMAIN_BASE = new URL("https://images-ext-1.discordapp.net");
...
export const VENCORD_BADGES_BASE = new URL("https://badges.vencord.dev");
export const EQUICORD_BASE = new URL("https://equicord.org");
export const EQUICORD_IMAGES_BASE = new URL("https://images.equicord.org");
export const TENOR_GIF_ID = "Ad";
export const TENOR_MP4_ID = "Po";
export const TENOR_WEBM_ID = "Ps";
export const TENOR_PNG_ID = "AD";
export const TENOR_WEBP_ID = "At";
export const TENOR_AWEBP_ID = "Ax";
...
export type ExtractedEmoji = UnicodeEmojiData | ExtractedCustomEmoji;
export type ExtractedEmojis = { unicode: UnicodeEmojiData[], custom: ExtractedCustomEmoji[]; };
...
export enum AssetType {
    TENOR_MEDIA = "tenor_media",
    WIKIMEDIA_SVG = "wikimedia_svg",
    ...
    GUILD_INVITE_SPLASH = "guild_invite_splash",
    ...
    CUSTOM_ROLE_ICON = "custom_role_icon",
    UNICODE_ROLE_ICON = "unicode_role_icon",
    APNG_STICKER = "apng_sticker",
...
export type Collectible = ProfileEffect | Nameplate | AvatarDecoration;
...
export const assetAvailability = {
    [AssetSource.TENOR]: {
        [AssetType.TENOR_MEDIA]: { animated: ["gif", "mp4", "webm", "awebp", "png", "webp"] }
    },
    [AssetSource.WIKIMEDIA]: {
        [AssetType.WIKIMEDIA_SVG]: { static: ["svg", "png", "webp", "jpg"] }
    },
    [AssetSource.TWITTER]: {
        [AssetType.TWITTER_IMAGE]: { static: ["png", "jpg", "webp"] }
    },
    [AssetSource.CDN]: {
        [AssetType.NAMEPLATE]: { animated: ["apng", "webm", "png", "webp", "jpg"] },
        [AssetType.PROFILE_EFFECT_PRIMARY]: { animated: ["apng", "png", "webp", "jpg"] },
    ...
    [AssetSource.EXTERNAL_IMAGE_PROXY]: {
        ...
        "image/webp": { static: ["webp", "png", "jpg"], animated: ["awebp", "webp", "png", "jpg"] },
        "image/avif": { static: ["avif", "png", "webp"], animated: ["avif", "awebp", "png", "webp"] },
        "image/jpeg": { static: ["jpg", "png", "webp"] },
    ...
    [AssetSource.ASSET_MEDIA_PROXY]: {
        ...
        [AssetType.GUILD_ICON]: { static: ["png", "webp", "jpg"], animated: ["gif", "awebp", "png", "webp", "jpg"] },
        [AssetType.GUILD_BANNER]: { static: ["png", "webp", "jpg"], animated: ["gif", "awebp", "png", "webp", "jpg"] },
        [AssetType.GUILD_INVITE_SPLASH]: { static: ["png", "webp", "jpg"], animated: ["gif", "awebp", "png", "webp", "jpg"] },
        [AssetType.GUILD_DISCOVERY_SPLASH]: { static: ["png", "webp", "jpg"], animated: ["gif", "awebp", "png", "webp", "jpg"] },
        [AssetType.CUSTOM_EMOJI]: { static: ["png", "webp", "jpg"], animated: ["gif", "awebp", "png", "webp", "jpg"] },
        [AssetType.UNICODE_EMOJI]: { static: ["svg"], },
        [AssetType.CLAN_BADGE]: { static: ["png", "webp", "jpg"], },
        [AssetType.PROFILE_BADGE]: { static: ["png", "webp", "jpg"], },
...
export interface ExternalConnection {
    ...
    enabled: boolean;
    hasMetadata: boolean;
    getPlatformUserUrl: (user: { id: string; }) => string;
...
export const BadgeNames: Record<string, string> = {
    ...
    premium: "Nitro Subscriber",
    premium_tenure_1_month: "Nitro Subscriber 1 Month",
    premium_tenure_3_month: "Nitro Subscriber 3 Month",
    premium_tenure_6_month: "Nitro Subscriber 6 Month",
    premium_tenure_12_month: "Nitro Subscriber 1 Year",
    premium_tenure_24_month: "Nitro Subscriber 2 Years",
    premium_tenure_36_month: "Nitro Subscriber 3 Years",
    premium_tenure_60_month: "Nitro Subscriber 5 Years",
    premium_tenure_72_month: "Nitro Subscriber 6 Years",
    premium_tenure_1_month_v2: "Nitro Subscriber 1 Month",
    premium_tenure_3_month_v2: "Nitro Subscriber 3 Month",
    premium_tenure_6_month_v2: "Nitro Subscriber 6 Month",
    premium_tenure_12_month_v2: "Nitro Subscriber 1 Year",
    premium_tenure_24_month_v2: "Nitro Subscriber 2 Years",
    premium_tenure_36_month_v2: "Nitro Subscriber 3 Years",
    premium_tenure_60_month_v2: "Nitro Subscriber 5 Years",
    premium_tenure_72_month_v2: "Nitro Subscriber 6 Years",
    guild_booster_lvl1: "Guild Booster Level 1",
    guild_booster_lvl2: "Guild Booster Level 2",
    guild_booster_lvl3: "Guild Booster Level 3",
    guild_booster_lvl4: "Guild Booster Level 4",
    guild_booster_lvl5: "Guild Booster Level 5",
    guild_booster_lvl6: "Guild Booster Level 6",
    guild_booster_lvl7: "Guild Booster Level 7",
    guild_booster_lvl8: "Guild Booster Level 8",
    guild_booster_lvl9: "Guild Booster Level 9",
    bot_commands: "Bot Commands",
    automod: "AutoMod",
    application_guild_subscription: "Application Guild Subscription",
    legacy_username: "Legacy Username",
    quest_completed: "Quest Completed",
    orb_profile_badge: "Orbs Apprentice"
};
...
export interface ShopCategoryHeaderContextMenuProps {
    name: string;
    heroLogoUrl?: string;
    heroBannerAsset?: {
        static?: string;
...
export interface Quest {
    ...
    config: {
        ...
        assets: {
            gameTile: string | null;
            gameTileDark: string | null;
            gameTileLight: string | null;
            hero: string | null;
            heroVideo: string | null;
            logotype: string | null;
            logotypeDark: string | null;
            logotypeLight: string | null;
        ...
        videoMetadata?: {
            assets: {
                ...
                videoPlayerVideoHls: string | null;
                videoPlayerThumbnail: string | null;
                videoPlayerVideoLowRes: string | null;
                videoPlayerCaption: string | null;
                videoPlayerTranscript: string | null;
            };
        };
    },
}

export interface QuestTileContextMenuProps {
    quest: Quest;
}

export interface ShopListingContextMenuProps {
    items: { skuId: string; }[];
...
export interface OrbsPopoutShopImageContextMenuProps {
    static: string;
    animated: string;
}
...
export interface ClanBadgeMessageContextMenuProps {
    guildId: string,
    guildTag: string,
    guildBadge: string;
}

export interface ProfileBadgeContextMenuProps {
...
export interface RoleIconMessageContextMenuProps {
    name: string,
    roleId: string,
    src: string,
...
export interface RoleIconProfileContextMenuProps {
    id: string,
    target: HTMLElement;
}

export interface ConnectionIconProfileContextMenuProps {
    userId: string,
    account: { type: string; };
}

export interface ConnectionExtrasProfileContextMenuProps {
    imageAlt: string,
    imageSrc: string;
}

export interface EmojiContextMenuProps {
    messageId?: string,
    animated: boolean,
    emojiName: string,
    emojiId?: string,
...
export interface DownloadifyUserProfile extends UserProfile {
    profileEffect?: null | {
        skuId: string;
    };
}
